...
func (a *application) startHandler(m *tbot.Message) {
	msg := "Что может *Сакральный Олень?*\n\nОтветит на вопрос:\nЗадай вопрос и ты получишь на него ответ." +
	"\nНа вопрос ответом должны быть да или нет.\n\nВыберет из нескольких вариантов:" +
	"\nРаздели варианты союзом *или*.\nНе забудь про *пробелы*, пример:Лечь спать *или* дочитать мангу?\n" +
	"\nПредскажет будущее:\nДля начала выбери свой знак зодиака.\nПросто напиши его на русском языке." +
	"\nДалее введи нужную команду.\n/today - предсказание на сегодня\n/tomorrow - предсказание на завтра" +
	"\n/daily - ежедневные предсказания\n\nВнимание:\n*Сакрального Оленя*нельзя тревожить," + 
	"\nзадавая один и тот же вопрос несколько раз.\nТакже нельзя задавать вопросы связанные с *Оленем*.\n" +
	"\nВажно:\nКто будет оскорблять *Сакрального Оленя*,\nтому не будет прощения вовек, будет он проклят," +
	"\nвсюду его будут поджидать неудачи и несчастья.\n\nВ случае нарушении правил выше\nты не получишь достоверного ответа."
